...
- [x] Bounded MCR 1.2 manifests, stable/run identities, and finding evidence links
...
- TensorRT engine metadata profile and compiler-build manifest
...
- GitHub/GitLab reusable CI components and policy-status annotations
