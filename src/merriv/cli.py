...
from merriv.attestation import create_mcr_predicate, create_mcr_statement
...
from merriv.target import verify_target_evidence_manifest
...
def _run_recorded_comparison(
    *,
    ...
    result = compare_exact_match(
        ...
        baseline_adapter_fingerprint="merriv.recorded@1",
        candidate_adapter_fingerprint="merriv.recorded@1",
        resamples=resamples,
...
def compare_api_command(
    ...
    * 1024,
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="merriv-api-cache-") as cache_root:
            result = compare_exact_match(
    ...
    try:
        ...
        def adapter_factory(
            ...
            if adapter_kind is BisectAdapterKind.ONNX:
                ...
                return onnx_adapter, f"merriv.onnxruntime:{onnx_adapter.adapter_fingerprint}"
            snapshot = build_local_snapshot(
                record.artifact,
                model_family=family,
                execution_config={"adapter": "recorded-output-v1"},
