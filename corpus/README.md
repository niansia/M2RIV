...
Holm profile uses Tango score inference. The CPU contracted-calibration
candidates are WARN or BLOCK within declared runner-specific accuracy bounds;
the retained NVIDIA target re-evaluation is BLOCK. The historical NVIDIA receipt
